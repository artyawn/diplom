...
//
//public class GroupsTasksForAdapter extends FirebaseRecyclerAdapter<CreateTaskClass, GroupsTasksForAdapter.MyViewHolder> {
//
//
//    public GroupsTasksForAdapter(
...
//    @Override
//    protected void
//    onBindViewHolder(@NonNull GroupsTasksForAdapter.MyViewHolder holder,
...
//    @NonNull
//    @Override
//    public GroupsTasksForAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
//    {
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycle_task_for, parent, false);
//        return new GroupsTasksForAdapter.MyViewHolder(view);
//    }
//
//
